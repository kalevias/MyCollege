        ...
        <div class="header">
                        ...
                        <div class="carousel-caption">
                            ...
                            <div class="col-2-3">
                                <div class="scholarship-form">
                                    <p class="scholarshipformHead museo">Answer a few questions to find
                                        scholarships.</p>
                                    ...
                                    <div class="col-1-1 bottom-bump" id="currentlyInHighShool" style="padding-right: 0; padding-left: 0;">
                                        <div class="col-7-12 museo questionLabel">Are you currently in high school?
                                        </div>
                                        <div class="col-5-12 clearfix">
                                            <div class="half-width">
                                    ...
                                    <div class="col-1-1 bottom-bump" style="padding-right: 0; padding-left: 0;">
                                        <div class="col-7-12 museo questionLabel">Will you study full time or part
                                            time?
                                        </div>
                                        <div class="col-5-12 clearfix">
                                            <div class="half-width">
                                                <input type="radio" name="ftPt" value="fullTime" id="ftPtYes"><label for="ftPtYes"><span></span>Full
                                                    Time</label>
                                            </div>
                                            <div class="half-width">
                                                <input type="radio" name="ftPt" value="partTime" id="ftPtNo"><label for="ftPtNo"><span></span>Part
                                                    Time</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-1-1 bottom-bump" id="schoolType" style="padding-right: 0; padding-left: 0;">
                                        <div class="col-7-12 museo questionLabel" style="padding-top: 5px;">What type of
                                    ...
                                    <div class="col-1-1" style="text-align: right; margin-top: 10px;">
                                        <button type="button" tabindex="5" id="searchByQuestions" class="nice medium orange button radius">
                                            Search
                                        </button>
                                    </div>
                                ...
                                <div class="scholarship-form" style="margin-top: 30px;">
                                    <p class="scholarshipformHead museo" style="margin-bottom: 5px;">Or search by name
                                        or keyword</p>
            ...
            <div class="row">
                <div class="leftcolumn">
                    ...
                    $scholarships = $dbc->query("select multiple", "SELECT pkcscholarship FROM tblcollegescholarship");
                    foreach ($scholarships as $sc) {
                        $scholarship = new CollegeScholarship($sc["pkcscholarship"]);
                        ?>
                        <div class="card">
                            <h2><?php echo $scholarship->getName(); ?></h2>
                            <h5><?php echo $scholarship->getCollege()->getName() ?>, <?php echo $scholarship->getType(); ?></h5>
